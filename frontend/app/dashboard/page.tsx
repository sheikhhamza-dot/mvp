      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        {children.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-400 mt-2 mb-6">Create a profile to get started.</p>
            <button onClick={() => setShowAddChild(true)}
            ...
            <form onSubmit={handleAddChild} className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="number" min={6} max={16} required value={childForm.age}
                    onChange={e => setChildForm(f => ({ ...f, age: +e.target.value }))}
                    className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Grade</label>
                  <input type="number" min={1} max={12} required value={childForm.grade}
              ...
              <div>
                ...
                <select value={childForm.proficiency_level}
              ...
              {addError && <p className="text-sm text-red-500 bg-red-50 px-3 py-2 rounded-lg">{addError}</p>}
